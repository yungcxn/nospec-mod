        ...
        boolean process(Token t, HtmlTreeBuilder tb) {
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    else if(startTag.normalName().equals("html")) {
                    	 tb.insertEmpty(startTag);
                    }else {
                    	return anythingElse(t, tb);
                    }
    ...
    InFrameset {
        boolean process(Token t, HtmlTreeBuilder tb) {
            if (isWhitespace(t)) {
                ...
                if(start.normalName().equals("html")){
                	return tb.process(start, InBody);
                }else if(start.normalName().equals("frameset")){
                	tb.insert(start);
                }else if(start.normalName().equals("frame")){
                	 tb.insertEmpty(start);
                }else if(start.normalName().equals("noframes")){
